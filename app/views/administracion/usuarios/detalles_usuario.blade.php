				...
				<div class="tabs">
					<div id="tab-2" class="tab">
						<article>
							...
							<h2>&nbsp;&nbsp;&nbsp;Detalles de Usuario >> [{{$usuario->usuario}}]</h2>
							<hr>
							<div>
								&nbsp;&nbsp;&nbsp;{{HTML::link('/Administracion/editarusuario/'.$usuario->id,'Editar',array('class'=>"btn btn-success"))}}
								&nbsp;&nbsp;&nbsp;{{HTML::link('/Administracion/eliminarusuario/'.$usuario->id,'Eliminar',array('class'=>"btn btn-success"))}}
								<hr>
								<div  style="width:650px;heigth:150px;margin-left:80px">
									<ul class="breadcrumb">
	  									<li><span class="label label-inverse">Usuario</span></li>&nbsp;&nbsp;<i class="fa fa-caret-right"></i>&nbsp;&nbsp;<li><span class="label label-info">{{$usuario->usuario}}</span></li>
									<br><br>
	  									<li><span class="label label-inverse">Email</span></li>&nbsp;&nbsp;<i class="fa fa-caret-right"></i>&nbsp;&nbsp;<li><span class="label label-info">{{$usuario->email}}</span></li>
									<br><br>
	  									<li><span class="label label-inverse">Imagen</span></li>&nbsp;&nbsp;<i class="fa fa-caret-right"></i>&nbsp;&nbsp;<li><span class="label label-info">{{($usuario->imagen)?($usuario->imagen):("Sin imagen")}}</span></li>
									<br><br>
	  									<li><span class="label label-inverse">Es super usuario</span></li>&nbsp;&nbsp;<i class="fa fa-caret-right"></i>&nbsp;&nbsp;<li><span class="label label-info">{{($usuario->is_superuser)?("Si"):("No")}}</span></li>
									<br><br>
	  									<li><span class="label label-inverse">Es estudiante</span></li>&nbsp;&nbsp;<i class="fa fa-caret-right"></i>&nbsp;&nbsp;<li><span class="label label-info">{{($usuario->is_estudiante)?("Si"):("No")}}</span></li>
	  								<br><br>
	  									<li><span class="label label-inverse">Activo</span></li>&nbsp;&nbsp;<i class="fa fa-caret-right"></i>&nbsp;&nbsp;<li><span class="label label-info">{{($usuario->is_activo)?("Si"):("No")}}</span></li>
									<br><br>
	  									<li><span class="label label-inverse">Ultima sesion</span></li>&nbsp;&nbsp;<i class="fa fa-caret-right"></i>&nbsp;&nbsp;<li><span class="label label-info">{{($usuario->ultima_sesion)?($usuario->ultima_sesion):("Sin inicio de sesion")}}</span></li>
									</ul>
								</div>
						    </div>
						</article>
