								...
								<form class="form-horizontal" method="post">
									...
									<div style="width:650px;heigth:150px;margin-left:80px">
										<div class="input-prepend">
	  										...
	  										<input class="span2" id="prependedInput" name="usuario" type="text" placeholder="Usuario">
										</div>
										<br><br>
										<div class="input-prepend">
	  										<span class="add-on">Email</span>
	  										<input class="span2" id="prependedInput" name="email" type="text" placeholder="Email">
										</div>
										<br><br>
										<div class="input-prepend">
										...
										<div class="input-prepend">
	  										...
	  										Si {{Form::radio('is_superuser', 1 )}}
	  										No {{Form::radio('is_superuser', 0, true)}}
										<br><br>
										<div class="input-prepend">
	  										<span class="add-on">Es Estudiante</span>
										</div>
											Si {{Form::radio('is_estudiante', 1)}}
	  										No {{Form::radio('is_estudiante', 0, true)}}
										<br><br>
										<div class="input-prepend">
	  										<span class="add-on">Usuario activo?</span>
										</div>
											Si {{Form::radio('is_activo', 1)}}
	  										No {{Form::radio('is_activo', 0, true)}}
										<br><br>
