...
<head>
  ...
  <body>
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="span4">
          <img class="img-circle" src="{{asset('/img/marketing/nav-01.jpg')}}">
          <h2>Animate</h2>
          <p>Veninversion te invita a pertenecer a nuestros grupos de inversionistas, te ofrecemos la mejor seguridad en la inversion que realices </p>
          
        </div><!-- /.span4 -->
        <div class="span4">
          <img class="img-circle" src="{{asset('/img/marketing/nav-02.jpg')}}">
          <h2>Gestiona</h2>
          <p>Consigue tus referidos para asi poder llegar a la posicion de cobrador y obtener las mejores ganancias.</p>
          
        </div><!-- /.span4 -->
        <div class="span4">
          <img class="img-circle" src="{{asset('/img/marketing/nav-03.jpg')}}">
          <h2>Ganancias</h2>
          <p>Obtienes las mejores ganancias</p>
            ...
            <!---FORMULARIOS-->
              <form class="form-horizontal">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text"  class="input-medium" name="usuario" id='inputUsuario' placeholder="Usuario">
                  </div>
                </div>
                <div class="control-group">
