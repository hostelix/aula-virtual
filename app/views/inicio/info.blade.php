  ...
  <body>
          ...
          <div class="navbar-inner  navbar-fixed-top" style="margin:10px 20px 0px 20px; ">
            ...
            <div class="nav-collapse collapse">
              <ul class="nav">
                ...
                <li  class="active"><a href="/info">Quienes Somos</a></li>
    ...
    <div class="container marketing">
      ...
      <div class="row">
        ...
        <div class="span4">
          ...
          <h2>Veninversion</h2>
          <p>Somos una empresa dedicada a las inversiones, ofrecemos el mejor servicio para que inviertas tu dinero y tripliques su cantidad obteniendo una ganancia neta de 400%. Vamos animate a entrar en nuestras mesas de inversiones, registrate gratis y podras ver mas informacion.</p>
          <label>RIF: J-00000000</label>
        </div><!-- /.span4 -->
        <div class="span4">
        </div><!-- /.span4 -->
      </div><!-- /.row -->
    ...
    <!-- endModals-->
      ...
      <footer>
        ...
        <p style="text-align:center; padding-top:60px;">Producida por &copy; SOFTelixBM 2014 . &middot; 
